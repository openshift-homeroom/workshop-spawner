{
    ...
    "apiVersion": "v1",
    "metadata": {
        "name": "workshop-jupyterhub-production-openshift-auth",
        "annotations": {
            "openshift.io/display-name": "Workshop (Production/OpenShift Auth)"
        }
    },
    "parameters": [
        {
        ...
        {
            "name": "TERMINAL_IMAGE",
            "value": "quay.io/osevg/workshop-terminal:master",
            "required": true
        },
        {
            "name": "JUPYTERHUB_IMAGE",
            "value": "quay.io/osevg/workshop-jupyterhub:master",
            "required": true
        },
        {
            "name": "OC_VERSION",
